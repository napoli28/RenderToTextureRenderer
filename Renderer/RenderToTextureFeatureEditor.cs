...
[CustomPropertyDrawer(typeof(RenderToTexture.RenderToTextureSetting), true)]
public class RenderToTextureFeatureEditor : PropertyDrawer
{
    internal class Styles
    {
        ...
        public static GUIContent clearColor = new GUIContent("Clear Color");
        ...
        public static GUIContent renderTextureHeader = new GUIContent("Render Texture");
        ...
        //RT Settings
        public static GUIContent rtName = new GUIContent("Name", "Name of render texture.");
        public static GUIContent rtScale = new GUIContent("Scale", "Scale of render texture, based on screen size.");
        public static GUIContent rtFormat = new GUIContent("Format");
        public static GUIContent rtFilterMode = new GUIContent("Filter Mode");
        public static GUIContent rtWrapMode = new GUIContent("Wrap Mode");
    }
    ...
    private HeaderBool m_RenderTextureFoldout;
    private int m_RenderTexutreLines = 5;
    ...
    private SerializedProperty m_ClearColor;
    ...
    //RT props
    private SerializedProperty m_rtSettings;
    private SerializedProperty m_rtName;
    private SerializedProperty m_rtScale;
    private SerializedProperty m_rtFormat;
    private SerializedProperty m_rtFilterMode;
    private SerializedProperty m_rtWrapMode;
    ...
    private void Init(SerializedProperty property)
    {
        ...
        m_RenderTextureFoldout = new HeaderBool($"{key}.RenderTextureFoldout");


        m_Callback = property.FindPropertyRelative("Event");
        m_PassTag = property.FindPropertyRelative("passTag");
        m_ClearColor = property.FindPropertyRelative("clearColor");
        m_Debug = property.FindPropertyRelative("debug");
        //Filter props
        ...
        //RT
        m_rtSettings = property.FindPropertyRelative("renderTextureSettings");
        m_rtName = m_rtSettings.FindPropertyRelative("textureName");
        m_rtScale = m_rtSettings.FindPropertyRelative("textureSizeScale");
        m_rtFormat = m_rtSettings.FindPropertyRelative("textureFormat");
        m_rtFilterMode = m_rtSettings.FindPropertyRelative("filterMode");
        m_rtWrapMode = m_rtSettings.FindPropertyRelative("wrapMode");
    ...
    public override void OnGUI(Rect rect, SerializedProperty property, GUIContent label)
    {
        ...
        Color clearColor = EditorGUI.ColorField(rect, Styles.clearColor, m_ClearColor.colorValue);
        rect.y += Styles.defaultLineSpace;
        bool debug = EditorGUI.Toggle(rect, Styles.debug, m_Debug.boolValue);
        if (EditorGUI.EndChangeCheck()) {
            m_Callback.intValue = selectedValue;
            m_ClearColor.colorValue = clearColor;
            m_Debug.boolValue = debug;
        }
        rect.y += Styles.defaultLineSpace;
    ...
    void DoRenderTexture(ref Rect rect)
    {
        m_RenderTextureFoldout.value = EditorGUI.Foldout(rect, m_RenderTextureFoldout.value, Styles.renderTextureHeader, true);
        SaveHeaderBool(m_RenderTextureFoldout);
        rect.y += Styles.defaultLineSpace;
        if (m_RenderTextureFoldout.value) {
            EditorGUI.indentLevel++;
            EditorGUI.PropertyField(rect, m_rtName, Styles.rtName);
            rect.y += Styles.defaultLineSpace;
            EditorGUI.PropertyField(rect, m_rtScale, Styles.rtScale);
            rect.y += Styles.defaultLineSpace;
            EditorGUI.PropertyField(rect, m_rtFormat, Styles.rtFormat);
            rect.y += Styles.defaultLineSpace;
            EditorGUI.PropertyField(rect, m_rtFilterMode, Styles.rtFilterMode);
            rect.y += EditorGUI.GetPropertyHeight(m_rtFilterMode);
            EditorGUI.PropertyField(rect, m_rtWrapMode, Styles.rtWrapMode);
            rect.y += EditorGUI.GetPropertyHeight(m_rtFilterMode);
            EditorGUI.indentLevel--;
        }
    }
    ...
    public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
    {
        ...
        Init(property);
        height += Styles.defaultLineSpace * 2; // add line for event and clear color
        ...
        height += m_RenderTextureFoldout.value ? Styles.defaultLineSpace * m_RenderTexutreLines : 0;
